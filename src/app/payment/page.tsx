          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="text-center mb-6">
                <h3
                  className={`text-2xl font-bold mb-2 ${getPlanTextColor(plan.id)}`}
                >
                  {plan.name}
                </h3>
              ...
              {plan.isEnterprise && (
                <div className="mb-6">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEnterpriseAmount(Number(e.target.value))
                    }
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                  ...
                  <ol className="list-decimal list-inside space-y-2 text-sm text-blue-800">
                    ...
                    <li>
                      Send exactly {paymentAddress.amount} THETA to the address
                    </li>
